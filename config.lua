...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 68) -- Gets max players from config file, default 48
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 750, bank = 11000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
--max weight 180000 max inv 41 check qb inv for this
QBConfig.Player = {}
...
QBConfig.Server.Discord = "https://discord.gg/projectoasis" -- Discord invite link
